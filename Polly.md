# [Polly](https://www.thepollyproject.org/)
 ...
 ### Polly - библиотек для обеспечения устойчисости .NET и обработки временных сбоев, позволяет применять таие политики как **повторная попытка**, **автоматический выключатель**, **тайм-аут**,**bulkhead isolation** и **резервное копирование** 
![polly](img/polly.png)
